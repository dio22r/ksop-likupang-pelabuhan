...
class MemberManagementController extends BaseController
{
	...
	public function view_index()
	{
		...
		$arrView = [
			...
			"arrJs" => [
				base_url("/assets/js/controller-admin/member-management/index.js?new"),
			],
		];

		return view("/admin_view/member-management/vw_index", $arrView);
	}
	...
	public function view_form($id = "")
	{
		...
		$arrView = [
			...
			"arrJs" => [
				base_url("/assets/js/controller-admin/member-management/form.js?new"),
			],
		...
		return view("/admin_view/member-management/vw_form", $arrView);
	}
