        ...
        <div class="col-md-8">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <form id="form" method="POST" action="<?= base_url("/member/ganti-password"); ?>" v-on:submit='submit($event)'>
...
<script src="<?= base_url("/assets/js/controller/user/ganti_password.js?v=1") ?>" defer></script>
