...
<div id="data-vue">
  ...
  <section id="content">
    ...
    <div class="container">
      <h1 class="display-4 text-center mt-2"> Member Management </h1>
        ...
        <div class="card-body">
          <div class="form-row justify-content-end">
            <div class="col-sm-9 text-left">
              <a href="<?= base_url("/admin/member-management/form"); ?>" class="btn btn-outline-primary btn-sm" type="button">
      ...
      <div class="modal-content">
        ...
        <div v-if="retrieve_process">
          ...
          <div class="modal-footer">
            ...
            <a v-bind:href="'<?= base_url("/admin/member-management/form"); ?>/' + detail.id" class="btn btn-sm btn-primary">
